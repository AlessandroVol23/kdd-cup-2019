...
{merged the different DFs for train [click, plan, queries] to a big Train-DF
and the different DFs for testing [plan, queries] to a big Test-DF}
...
Data:
	...
	- Test and Train have the same structure. 
	  Only Differenc: Test_Set has no Colum "Click_Mode" & "Click_Time"
	       ...
	       --> "Click_Time" can not be used as feature, as its missing in Test!
